...
def _truncate_for_speech(text: str, limit: int = 2000) -> str:
    """Truncate text to *limit* chars, appending an ellipsis if shortened."""
    if len(text) > limit:
        return text[:limit] + "... (truncated for speech)"
    return text
